...
public class ApiKeyInitializer implements ServletContextListener {
  ...
  private static final Logger LOGGER = Logger.getLogger(ApiKeyInitializer.class
          .getName());
  ...
  public void contextInitialized(ServletContextEvent event) {
    if (LOGGER.isLoggable(Level.INFO)) LOGGER.info("Reading " + PATH + " from resources (probably from " +
        "WEB-INF/classes");
    String key = getKey();
