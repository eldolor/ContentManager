...
public class CopyOfStripeChargeEmailBuilder {
	...
	public String build(String htmlFormattedHeader, String htmlFormattedCallout) {
		...
		email.append(HEAD_BEGIN);
		email.append(STYLE);
		email.append(HEAD_END);
	...
	public static void main(String[] args) {
		...
		lHtmlFormattedHeader.append("<p class=\"lead\">Welcome to Skok.</p>");
		lHtmlFormattedHeader
				.append("<p class=\"lead\">Skok is an Advanced Content Management and  Delivery platform for your Mobile Apps. Skok delivers rich content to your Mobile Apps, and stores it locally on mobile devices.</p>");
		lHtmlFormattedHeader
				.append("<p class=\"lead\">This elevates user experience of your Mobile Apps. Your content loads much faster, and users can engage with your rich content, even if they lose their data connection.</p>");

		lHtmlFormattedHeader
				.append("<p class=\"lead\">You can find out more at <a href=\"http://skok.co/docs/overview\">Skok</a> </p>");

		StringBuilder lHtmlFormattedCallout = new StringBuilder();
		lHtmlFormattedCallout.append("<p><b>Powerful New Features</b></p>");
		...
		lHtmlFormattedCallout.append("</ol>");
		System.out.println(new CopyOfStripeChargeEmailBuilder().build(
