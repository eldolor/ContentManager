					...
					<fieldset>
							...
							<div class="row">
								<div class="large-12 columns">
									<div class="name-field">
										<label>By using the &lt;&nbsp;&gt;.com web site
											("Service"), or any services of &lt;&nbsp;&gt;, Inc
											("&lt;&nbsp;&gt;"), you are agreeing to be bound by the
											following terms and conditions ("Terms of Service"). IF YOU
											ARE ENTERING INTO THIS AGREEMENT ON BEHALF OF A COMPANY OR
											OTHER LEGAL ENTITY, YOU REPRESENT THAT YOU HAVE THE AUTHORITY
											TO BIND SUCH ENTITY, ITS AFFILIATES AND ALL USERS WHO ACCESS
											OUR SERVICES THROUGH YOUR ACCOUNT TO THESE TERMS AND
											...
											THIS AGREEMENT AND MAY NOT USE THE SERVICES. </label>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="large-12 columns">
									<div class="name-field">
										<label>If &lt;&nbsp;&gt; makes material changes to
											these Terms, we will notify you by email or by posting a
											notice on our site before the changes are effective. Any new
											...
											changes. You can review the most current version of the Terms
								...
								<div class="large-12 columns">
									<div class="name-field">
										<label>Violation of any of the terms below will result
											in the termination of your Account. While &lt;&nbsp;&gt;
											prohibits such conduct and Content on the Service, you
											understand and agree that &lt;&nbsp;&gt; cannot be
											responsible for the Content posted on the Service and you
											nonetheless may be exposed to such materials. You agree to
											use the Service at your own risk.</label>
									</div>
								</div>
							</div>
						</fieldset>
								...
								<div class="large-12 columns">
									<div class="name-field">
										<label>5. You are responsible for maintaining the
											security of your account and password. &lt;&nbsp;&gt; cannot
											and will not be liable for any loss or damage from your
											failure to comply with this security obligation.</label>
									</div>
								</div>
							</div>
							<div class="row">
						...
						<fieldset>
								...
								<div class="large-12 columns">
									<div class="name-field">
										<label>Any use of the SDK, including use of the SDK
											through a third-party product that accesses &lt;&nbsp;&gt;,
											is bound by these Terms of Service plus the following
											specific terms:</label>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="large-12 columns">
									<div class="name-field">
										<label>1. You expressly understand and agree that
											...
											damages), resulting from your use of the SDK or third-party
											products that access data via the SDK.</label>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="large-12 columns">
									<div class="name-field">
										<label>2. Abuse or excessively frequent requests to
											&lt;&nbsp;&gt; via the SDK may result in the temporary or
											permanent suspension of your account's access to the API.
											&lt;&nbsp;&gt;, in its sole discretion, will determine abuse
											or excessive usage of the API. &lt;&nbsp;&gt; will make a
											reasonable attempt via email to warn the account owner prior
											to suspension.</label>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="large-12 columns">
									<div class="name-field">
										<label>3. &lt;&nbsp;&gt; reserves the right at any
											time to modify or discontinue, temporarily or permanently,
											your access to the API (or any part thereof) with or without
											notice.</label>
									</div>
								</div>
							</div>
								...
								<div class="large-12 columns">
									<div class="name-field">
										<label>4. When changing from a monthly billing cycle
											to a yearly billing cycle, &lt;&nbsp;&gt; will bill for a
											full year at the next monthly billing date.</label>
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="large-12 columns">
									<div class="name-field">
										<label>6. For any upgrade or downgrade in plan level
											...
											yearly plan, &lt;&nbsp;&gt; will immediately charge or refund
											the difference in plan cost, prorated for the remaining time
											in your yearly billing cycle.</label>
									</div>
								</div>
							</div>
							<div class="row">
						...
						<fieldset>
							...
							<div class="row">
								<div class="large-12 columns">
									<div class="name-field">
										<label>4. &lt;&nbsp;&gt;, in its sole discretion, has
											the right to suspend or terminate your account and refuse any
											and all current or future use of the Service, or any other
											&lt;&nbsp;&gt; service, for any reason at any time. Such
											termination of the Service will result in the deactivation or
											deletion of your Account or your access to your Account, and
											the forfeiture and relinquishment of all Content in your
											Account. &lt;&nbsp;&gt; reserves the right to refuse service
											to anyone for any reason at any time.</label>
									</div>
								</div>
							</div>
						</fieldset>
						<fieldset>
							...
							<div class="row">
								<div class="large-12 columns">
									<div class="name-field">
										<label>3. &lt;&nbsp;&gt; shall not be liable to you or
											to any third-party for any modification, price change,
											suspension or discontinuance of the Service.</label>
									</div>
								</div>
							</div>
						</fieldset>
						<fieldset>
							...
							<div class="row">
								<div class="large-12 columns">
									<div class="name-field">
										<label>2. &lt;&nbsp;&gt; does not pre-screen Content,
											but &lt;&nbsp;&gt; and its designee have the right (but not
											the obligation) in their sole discretion to refuse or remove
											any Content that is available via the Service.</label>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="large-12 columns">
									<div class="name-field">
										<label>3. You shall defend &lt;&nbsp;&gt; against any
											claim, demand, suit or proceeding made or brought against
											...
											of a third-party or violates applicable law, and shall
											indemnify &lt;&nbsp;&gt; for any damages finally awarded
											against, and for reasonable attorney&apos;s fees incurred by,
											&lt;&nbsp;&gt; in connection with any such claim, demand,
											suit or proceeding; provided, that &lt;&nbsp;&gt; (a)
											promptly gives You written notice of the claim, demand, suit
											or proceeding; (b) gives You sole control of the defense and
											settlement of the claim, demand, suit or proceeding (provided
											that You may not settle any claim, demand, suit or proceeding
											unless the settlement unconditionally releases &lt;&nbsp;&gt;
											of all liability); and (c) provides to You all reasonable
											assistance, at Your expense.</label>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="large-12 columns">
									<div class="name-field">
										<label>4. The look and feel of the Service is
											copyright ©2010 &lt;&nbsp;&gt; Inc. All rights reserved. You
											may not duplicate, copy, or reuse any portion of the
											HTML/CSS, Javascript, or visual design elements or concepts
											without express written permission from &lt;&nbsp;&gt;.</label>
									</div>
								</div>
							</div>
						</fieldset>
						<fieldset>
								...
								<div class="large-12 columns">
									<div class="name-field">
										<label>3. You understand that &lt;&nbsp;&gt; uses
											third-party vendors and hosting partners to provide the
											necessary hardware, software, networking, storage, and
											related technology required to run the Service.</label>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="large-12 columns">
									<div class="name-field">
										<label>4. You must not modify, adapt or hack the
											...
											it is associated with the Service, &lt;&nbsp;&gt;, or any
											other &lt;&nbsp;&gt; service.</label>
									</div>
								</div>
							</div>
								...
								<div class="large-12 columns">
									<div class="name-field">
										<label>5. You may use the &lt;&nbsp;&gt; Pages static
											...
											no other purpose. You may not use &lt;&nbsp;&gt; Pages in
											violation of &lt;&nbsp;&gt;'s trademark or other rights or in
											violation of applicable law. &lt;&nbsp;&gt; reserves the
											right at all times to reclaim any &lt;&nbsp;&gt; subdomain
											without liability to you.</label>
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="large-12 columns">
									<div class="name-field">
										<label>8. Verbal, physical, written or other abuse
											...
											&lt;&nbsp;&gt; customer, employee, member, or officer will
											result in immediate account termination.</label>
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="large-12 columns">
									<div class="name-field">
										<label>12. If your bandwidth usage significantly
											...
											&lt;&nbsp;&gt;) of other &lt;&nbsp;&gt; customers, we reserve
											the right to immediately disable your account or throttle
											your file hosting until you can reduce your bandwidth
											consumption.</label>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="large-12 columns">
									<div class="name-field">
										<label>13. &lt;&nbsp;&gt; does not warrant that (i)
											the service will meet your specific requirements, (ii) the
								...
								<div class="large-12 columns">
									<div class="name-field">
										<label>14. You expressly understand and agree that
											...
											the service; (ii) the cost of procurement of substitute goods
							...
							<div class="row">
								<div class="large-12 columns">
									<div class="name-field">
										<label>15. The failure of &lt;&nbsp;&gt; to exercise
											or enforce any right or provision of the Terms of Service
											shall not constitute a waiver of such right or provision. The
											Terms of Service constitutes the entire agreement between you
											and &lt;&nbsp;&gt; and govern your use of the Service,
											superseding any prior agreements between you and
											&lt;&nbsp;&gt; (including, but not limited to, any prior
											versions of the Terms of Service). You agree that these Terms
											of Service and Your use of the Service are governed under
											California law.</label>
									</div>
								</div>
							</div>
							<div class="row">
