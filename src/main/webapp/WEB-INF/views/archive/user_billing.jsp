...
<div class="large-9 columns content" id="user_billing">
	<form id="updateBillingForm" name="updateBillingForm" data-abide="ajax">
		<fieldset>
			...
			<div id="user_billing_container">
				...
				<div class="row">
					<div class="large-12 columns">
						<dl>
							<dt>
								Credit card number - <a href="javascript:void(0);" id="new_card">Enter
									a new card</a> <a href="javascript:void(0);" id="new_card_cancel"
				...
				<div class="row" id="new_card_container" style="display: none">
					<div class="large-9 columns">
						...
						<input type="text" id="card_number" name="card_number" size="20"
							pattern="card" /></label>
					</div>
				...
				<div class="row">
					<div class="large-12 columns">
						<label for="card_address_line_1">Address line 1 <input
							type="text" id="card_address_line_1" name="card_address_line_1" /></label>
					</div>
				</div>
				<div class="row">
					<div class="large-12 columns">
						<label for="card_address_line_2">Address line 2 <input
							type="text" id="card_address_line_2" name="card_address_line_2" /></label>
					</div>
				</div>
				<div class="row">
					<div class="large-12 columns">
