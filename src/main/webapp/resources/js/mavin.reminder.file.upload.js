function setupReminderAdDropBox(url, bannerSize) {
	...
	var dropbox = $('#reminder_ad_dropbox'), message = $('.message', dropbox);
	...
	var options = {
		...
		uploadFinished : function(i, file, response) {
			...
			$('#reminder_ad_uri').val(response.uri);
			//set the banner size for the image that was uploaded
			$('#reminder_ad_banner_size').val(lBannerSize);
		},
