function setupVideoAdDropBox(url) {
	var lUrl = url;
	console.log("setupVideoAdDropBox url: " + lUrl);
	
	var dropbox = $('#video_ad_dropbox'), message = $('.message', dropbox);
