function setupVoiceAdDropBox(url) {
	var lUrl = url;

	var dropbox = $('#voice_ad_dropbox'), message = $('.message', dropbox);
	...
	function createImage(file) {
		...
		reader.onload = function(e) {
			...
			image.attr('src', 'resources/images/audio_icon.jpg');
		};
